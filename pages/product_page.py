...
class ProductPage(BasePage):
    ...
    def should_be_a_message(self):
        assert 'был добавлен в вашу корзину' or 'has been added' in self.elements_present(*ProductPageLocators.PRODUCT_MESSAGE)[0],"No acception message for item've added to cart"
    ...
    def should_be_product_cart_price_message(self):
        assert 'Стоимость корзины теперь составляет' or 'Your basket total is' in self.elements_present(*ProductPageLocators.PRODUCT_CART_PRICE_MESSAGE)[0], "No price message for item've added to cart"
